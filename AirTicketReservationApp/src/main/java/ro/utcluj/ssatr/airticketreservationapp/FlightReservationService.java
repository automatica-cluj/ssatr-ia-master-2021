...
public class FlightReservationService {
    ...
    public boolean makeReservation(String flightNumber, int noOfTikets ){
        try {
            ...
            //            if(fi.getFlightNumber().equals(flightNumber)){
            //                if(fi.getNumberOfSeats()>=noOfTikets){
            //                    System.out.println("Make new reservation for flight "+flightNumber+ " and no of seats "+noOfTikets);
            //                    fi.setNumberOfSeats(fi.getNumberOfSeats()-noOfTikets);
            //                    return true;
            //                }//.if
            //            }//.if
            //        }//.for
